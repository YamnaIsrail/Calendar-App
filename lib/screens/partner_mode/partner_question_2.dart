...
class PartnerSweetNicknameScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController sweetNicknameController = TextEditingController();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  "Enter a sweet nickname that your partner calls you.",
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.black,
                  ),
                ...
                Container(
                  ...
                  child: TextFormField(
                    controller: sweetNicknameController,
                    textAlign: TextAlign.center,
                    decoration: InputDecoration(
                      hintText: "Enter sweet nickname",
                ...
                Padding(
                  ...
                  child: CustomButton(
                    text: "Next",
                    onPressed: () {
                      // Save the nickname to the provider
                      partnerModeProvider.setPartnerNickname(sweetNicknameController.text.trim());
                      // Navigate to next screen
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (
                            context) => HomePartnerFlow()),
                      );
                    },
                    backgroundColor: greyBlueColor,
